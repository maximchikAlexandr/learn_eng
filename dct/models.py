...
class EngWord(db.Model):
    ...
    translated_words = db.relationship(
        "TrRusWord",
        secondary=eng_rus_words,
        backref=db.backref("eng_words", lazy="dynamic"),
    )
